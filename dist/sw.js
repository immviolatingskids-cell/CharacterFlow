...
self.addEventListener('install',event=>{self.skipWaiting();event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(['./','index.html','styles.css','tokens.css','app.js','library-data.js','ui-assets.js','studio-core.js','resolver-v1.js','style-packs.js','manifest.json'])))});
