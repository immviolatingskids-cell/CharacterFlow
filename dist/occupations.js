...
const adjacentByPack={ 'tech-girlie':['data-scientist','cybersecurity-analyst'], 'gym-girlie':['paramedic','social-worker'], booktok:['research-librarian','teacher'], y2k:['sound-designer','event-producer'], streetwear:['urban-planner','journalist'], 'clean-girl':['coffee-roaster','landscape-designer'], coquette:['florist','ceramic-artist'], 'dark-academia':['research-librarian','translator'], goth:['sound-designer','animator'], emo:['sound-engineer','book-editor'], grunge:['mechanic','ceramic-artist'], preppy:['teacher','architect'], 'old-money':['curator','bookshop-owner'], boho:['landscape-designer','travel-writer'], gorpcore:['marine-conservationist','ecologist'] };
const wildcardByPack={ 'tech-girlie':['florist','night-auditor'], 'gym-girlie':['librarian','ceramic-artist'], booktok:['marine-biologist','electrician'], y2k:['museum-archivist','florist'], streetwear:['marine-biologist','librarian'], 'clean-girl':['mechanic','sound-engineer'], coquette:['cybersecurity-analyst','urban-planner'], 'dark-academia':['fitness-coach','florist'], goth:['landscape-designer','teacher'], emo:['urban-planner','coffee-roaster'], grunge:['librarian','research-scientist'], preppy:['mechanic','sound-engineer'], 'old-money':['game-designer','paramedic'], boho:['data-scientist','night-auditor'], gorpcore:['book-editor','florist'] };
export const OCCUPATION_RELATIONSHIPS = Object.freeze(Object.fromEntries(Object.entries(packSeeds).map(([pack, ids]) => [pack, R(pack, ids.map(([id,w])=>[id,Number(w),why('likely')]), (adjacentByPack[pack]||[]).map((id,index)=>[id,.62-index*.04,why('adjacent')]), (wildcardByPack[pack]||[]).map((id,index)=>[id,.54-index*.04,why('wildcard')]))])));
