...
self.addEventListener('install',event=>{self.skipWaiting();event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(['./','index.html','styles.css','tokens.css','app.js','studio-core.js','manifest.json'])))});
